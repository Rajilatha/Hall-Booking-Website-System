							...
							<tbody>
								...
								<?php 
											if(isset($_POST["submit"])) {
												...
												$sql = "SELECT * FROM confirm WHERE CustomerID LIKE '%{$_POST["keyname"]}%' OR Meals LIKE '%{$_POST["keyname"]}%' OR EPackage LIKE '%{$_POST["keyname"]}%' OR Rooms LIKE '%{$_POST["keyname"]}%'"; 
											...
											if ($result->num_rows>0 ) {
											  ...
											  while($row = $result->fetch_assoc()) {
													...
													echo "<tr>";
														  ...
														  echo "<td>"; echo $row['Meals'];  echo "</td>";
														  echo "<td>"; echo $row['EPackage'];  echo "</td>";
														  echo "<td>"; echo $row['Rooms'];  echo "</td>";
						...
						<div class="modal-header">
							...
							<h5 class="modal-title" id="exampleModalLabel">
								<div class="w3-container" style="background-color: #8cd98c">
									<h2><i class="fa fa-eye"></i> View Confirm Details</h2>
								</div>
							</h5>
						</div>	
								...
								<div id="modal-content">
									<div class="container " style="width:600px">
										...
										<input type="hidden" name="eecus_id" id="eecus_id" />
											...
											<p>
												<input  disabled class="w3-input" name="customerid" value=""  id="customerid">
												<label>CustomerID</label></p>
											</p>

											<p>
												<input  disabled class="w3-input" name="meals" value=""  id="meals">
												<label>Meals</label></p>
											</p>
											<p>
												<input  disabled class="w3-input" name="employee" value=""  id="emmployee">
												<label>Epackage</label></p>
											</p>

											<p>
												<input  disabled class="w3-input" name="rooms" value=""  id="rooms">
												<label>Rooms</label></p>
											</p>
