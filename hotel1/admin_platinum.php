							...
							<tbody>
								...
								<?php 
											if(isset($_POST["submit"])) {
												...
												$sql = "SELECT * FROM platinum WHERE CustomerID LIKE '%{$_POST["keyname"]}%' OR Date LIKE '%{$_POST["keyname"]}%' OR Time LIKE '%{$_POST["keyname"]}%' OR dob LIKE '%{$_POST["keyname"]}%' OR people LIKE '"; 
											...
											if ($result->num_rows>0 ) {
											  ...
											  while($row = $result->fetch_assoc()) {
													...
													echo "<tr>";
														  ...
														  echo "<td>"; echo $row['people'];  echo "</td>";
