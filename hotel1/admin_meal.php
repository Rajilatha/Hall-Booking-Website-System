					 ...
					 function conDelete(y) 
{
 ...
 if(x) {
 	...
 	window.location.replace("admin_delect.php?id="+y);
									...
									<tr>
										...
										<th></th>		
											...
											if(isset($_POST["submit"])) {
												...
												$sql = "SELECT * FROM meal WHERE meal_name LIKE '%{$_POST["keyname"]}%' OR meal_description LIKE '%{$_POST["keyname"]}%' OR price LIKE '%{$_POST["keyname"]}%' OR meal_type LIKE '%{$_POST["keyname"]}%'";
											...
											if ($result -> num_rows>0 ) {
											  ...
											  while($row = $result->fetch_assoc()) {
													...
													echo "<tr>";
														  ...
														  echo "<td>"; echo $row['meal_name'];  echo "</td>";
														  echo "<td>"; echo $row['meal_description'];  echo "</td>";
														  echo "<td>"; echo "<img src=Images/".$row['image_link'].">"; echo "</td>";
														  echo "<td>"; echo $row['meal_type'];  echo "</td>";
														  echo "<td>"; echo $row['price'];  echo "</td>";
														  echo "<td>";
														  echo "<button type='button' class='btn btn-danger'> <a style='color:white;text-decoration:none;' onClick='conDelete({$row["meal_id"]})'>Delete </a></button>";
														  echo "</td>";
