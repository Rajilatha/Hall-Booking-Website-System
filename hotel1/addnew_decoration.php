					...
					<div class=" row">
						...
						<div class="col-lg-10 col-lg-offset-1 w3-white">
							<div class="w3-card-4 w3-col s12 w3-margin">
								<div class="w3-margin">			
									<div class=" ">
										<div class="mealss" style="font-size:22px; padding-left:20px;"> <br> Add a decoration 
										</div>
									</div>
									<div class="col-12">
										<form   id="add_meal" method="POST" action="./decorationadd.php" enctype="multipart/form-data">
											<div class="col-6">
												<div class="w3-half w3-padding">      
													<input class="w3-input w3-border" name="decoration_id" type="text" placeholder="Decoration ID"  id="decoration_id"></div>
												<div class="w3-half w3-padding">      
													<input class="w3-input w3-border" name="decoration_name" type="text" placeholder="Decoration Name"  id="decoration_name" required="required"></div>
												...
												<div class="w3-padding">
													<select class="w3-select w3-border" name="eType" data-validation="required" data-validation-error-msg="Please Select a Category" id="eType">
														<option value=""  selected>Select Decoration Type</option>
											...
											<div class="col-6">
												<div class="">
														...
														<div id="imageVal" style="width:100%;height:100%"><img id="myImg" src="121.jpg" alt="meal image" class="w3-image" style="width:68%;height:80%"/>
														</div>
														<br>		
												...
												<div class="w3-row-padding w3-margin-bottom">	
													<div class="w3-half">
														<input type="submit" class="w3-btn w3-green w3-block " name="decoration_add" value="Add Decoration">
													</div> 
													<div class="w3-half">
														<input type="reset" class="w3-btn w3-red w3-block " name="Decoration-cancel" value="Cancel">
													</div>								
												</div>
