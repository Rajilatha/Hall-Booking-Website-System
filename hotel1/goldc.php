 ...
 function conDelete(y) 
{
 ...
 if(x) {
 	...
 	window.location.replace("gold_delete.php?id="+y);
...
<button class="button"><a href="gBooking.php" style="color:white; font-weight:bold; margin:5px;">Booking</a></button>
...
<table id="customers" >
  <tr><td>Hall Name</td><td>Gold</td></tr>
  <tr><td>Seated</td><td>500</td></tr>
  <tr><td>Floor Area</td><td>5000 Square feet</td></tr>
  <tr><td>Floor</td><td>2nd Floor</td></b></tr>
  <tr><td>Price</td><td>100,000/=</td></b></tr>
</table>
