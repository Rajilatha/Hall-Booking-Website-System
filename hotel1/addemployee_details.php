		  ...
		  <!-- Navbar content -->
			 ...
			 <div id="navcontent">
						...
						<a class="navbar-brand" style="color:White;" href="Arrangement.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Arrangement&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
						  ...
						  <a class="navbar-brand" style="color:White;" href="confirmdetails.php">Customer Details			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
					...
					<div class=" row">
						...
						<div class="col-lg-10 col-lg-offset-1 w3-white">
							<div class="w3-card-4 w3-col s12 w3-margin">
								<div class="w3-margin">			
									<div class=" ">
										<div class="employee" style="font-size:22px; padding-left:20px;"> <br> Add Employee Package Details
										</div>
									</div>
									<div class="col-12">
										<form   id="add_employee" method="POST" action="./addnewemployee.php" enctype="multipart/form-data">
											<div class="col-6">
												<div class="w3-half w3-padding">      
													<input class="w3-input w3-border" name="package_no" type="int" placeholder="Package No"  id="package_no_no"></div>
												<div class="w3-half w3-padding">      
													
												</div>
												<div class="w3-padding">
													<select class="w3-select w3-border" name="emTypeType" data-validation="required" data-validation-error-msg="Please Select a Type" id="eType">
												...
												<div class="w3-row-padding w3-margin-bottom">	
													<div class="w3-half">
														<input type="submit" class="w3-btn w3-green w3-block " name="employee_add" value="Add Employee Package Details">
													</div> 
													<div class="w3-half">
														<input type="reset" class="w3-btn w3-red w3-block " name="employee-cancel" value="Cancel">
													</div>								
												</div>
