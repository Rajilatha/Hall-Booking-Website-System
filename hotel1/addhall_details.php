		  ...
		  <!-- Navbar content -->
			 ...
			 <div id="navcontent">
						...
						<a class="navbar-brand" style="color:White;" href="arrangement.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Arrangement&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
                          <a class="navbar-brand" style="color:White;" href="admin_halldetails.php">Hall Details&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
                          <a class="navbar-brand" style="color:White;" href="customerdetails.php">Customer Details			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
						<a class="navbar-brand" style="color:White;"href="adminview_booking_details.php" >Booking					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
					...
					<div class=" row">
						...
						<div class="col-lg-10 col-lg-offset-1 w3-white">
							<div class="w3-card-4 w3-col s12 w3-margin">
								<div class="w3-margin">			
									<div class=" ">
										<div class="mealss" style="font-size:22px; padding-left:20px;"> <br> Add Hall Details 
										</div>
									</div>
									<div class="col-12">
										<form   id="add_hall" method="POST" action="./addnewhalldetails.php" enctype="multipart/form-data">
											<div class="col-6">
												<div class="w3-half w3-padding">      
													<input class="w3-input w3-border" name="hall_id" type="text" placeholder="Hall ID"  id="hall_id"></div>
												<div class="w3-half w3-padding">      
													<input class="w3-input w3-border" name="hall_name" type="text" placeholder="Hall Name"  id="Hall_name" required="required"></div>
													<div class="w3-half w3-padding">  
												<input class="w3-input w3-border" name="capacity" type="text" placeholder="Capacity"  id="Capacity" required="required"></div>
												
												<div class="w3-padding">
													<input class="w3-input w3-border" name="price" type="text" placeholder="Price (LKR)"  id="price"></div>
													<div class="w3-half w3-padding">  
												<input class="w3-input w3-border" name="floor" type="text" placeholder="Floor"  id="Floor" required="required"></div>
											...
											<div class="col-6">
												<div class="">
														...
														<div id="imageVal" style="width:100%;height:100%"><img id="myImg" src="2.jpg" alt="meal image" class="w3-image" style="width:68%;height:80%"/>
														</div>
														<br>		
												...
												<div class="w3-row-padding w3-margin-bottom">	
													<div class="w3-half">
														<input type="submit" class="w3-btn w3-green w3-block " name="hall_add" value="Add Hall">
													</div> 
													<div class="w3-half">
														<input type="reset" class="w3-btn w3-red w3-block " name="hall-cancel" value="Cancel">
													</div>								
												</div>
