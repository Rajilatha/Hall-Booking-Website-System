...
<div class="header col-12">
	<h1 style="font-family:Papyrus">JK ONLINE HALL BOOKING<a href="Login.php"><image src="l.jpg" width="10%" height="10%" align="right"><br></a></h1></h1>
...
<div class=" col-5">
						<img class="d-block w-100" src="9IOGfY-register-button-blue-png-picture.png" alt="First slide" width="500px" height="500">
					</div>
...
<div class="container col-6">
 ...
 <?php include('errors.php'); ?>
   ...
   <label for="firstname">FirstName</label>
    ...
    <input type="password" id="cpwd" name="cpsw" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>
