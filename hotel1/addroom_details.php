					...
					<div class=" row">
						...
						<div class="col-lg-10 col-lg-offset-1 w3-white">
							<div class="w3-card-4 w3-col s12 w3-margin">
								<div class="w3-margin">			
									<div class=" ">
										<div class="mealss" style="font-size:22px; padding-left:20px;"> <br> Add Room Details
										</div>
									</div>
									<div class="col-12">
										<form   id="add_meal" method="POST" action="./addnewroom.php" enctype="multipart/form-data">
											<div class="col-6">
												<div class="w3-half w3-padding">      
													<input class="w3-input w3-border" name="room_no" type="text" placeholder="Room No"  id="room_no"></div>
												<div class="w3-half w3-padding">      
													
												</div>
												<div class="w3-padding">
													<select class="w3-select w3-border" name="rType" data-validation="required" data-validation-error-msg="Please Select a Type" id="eType">
												...
												<div class="w3-padding">
													<select class="w3-select w3-border" name="rmType" data-validation="required" data-validation-error-msg="Please Select a Category" id="cType">
														<option value=""  selected>Room Category</option>
												...
												<div class="w3-padding">
													<input class="w3-input w3-border" name="c" type="int" placeholder="Cost (LKR)"  id="cost">
												</div>
											</div>
											...
											<div class="col-6">
												<div class="">
														...
														<div id="imageVal" style="width:100%;height:100%"><img id="myImg" src="single-bed-room-services-500x500.jpg" alt="meal image" class="w3-image" style="width:68%;height:80%"/>
														</div>
														<br>		
												...
												<div class="w3-row-padding w3-margin-bottom">	
													<div class="w3-half">
														<input type="submit" class="w3-btn w3-green w3-block " name="room_add" value="Add Room Details">
													</div> 
													<div class="w3-half">
