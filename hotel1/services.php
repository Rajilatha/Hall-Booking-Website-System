...
function update2(y)
{
 ...
 if(x) {
 	...
 	window.location.replace("Confirmation3.php?id="+y);
...
function update3(y)
{
 ...
 if(x) {
 	...
 	window.location.replace("Confirmation4.php?id="+y);
...
$id=$_SESSION['CustomerID'];
										$sql = "select * from silver where `Date`>CURRENT_DATE()+14 AND CustomerID=$id";
            ...
            echo "<tr>";
				...
				echo "<button type='button' class='btn btn-danger'> <a style='color:black;text-decoration:none;' onClick='conDelete({$row["booking_id"]})'>Cancel </a></button>";
						...
						echo "</td>";
                echo "<td>";
				echo "<button type='button' class='btn btn-danger'> <a style='color:black;text-decoration:none;' onClick='update1({$row["booking_id"]})'>Confirm </a></button>";
...
<?php
$id=$_SESSION['CustomerID'];
$sql = "select * from platinum where `Date`>CURRENT_DATE()+14 AND CustomerID=$id";
                                  $result = $con -> query($sql);
            ...
            echo "<tr>";
				...
				echo "<button type='button' class='btn btn-danger'> <a style='color:black;text-decoration:none;' onClick='Del({$row["booking_id"]})'>Cancel </a></button>";
						...
						echo "</td>";	
 echo "<td>";
				echo "<button type='button' class='btn btn-danger'> <a style='color:black;text-decoration:none;' onClick='update2({$row["booking_id"]})'>Confirm </a></button>";
...
<?php
$id=$_SESSION['CustomerID'];
$sql = "select * from gold where `Date`>CURRENT_DATE()+14 AND CustomerID=$id";
                                  $result = $con -> query($sql);
            ...
            echo "<tr>";
				...
				echo "<button type='button' class='btn btn-danger'> <a style='color:black;text-decoration:none;' onClick='Delete({$row["booking_id"]})'>Cancel </a></button>";
						...
						echo "</td>";	
 echo "<td>";
				echo "<button type='button' class='btn btn-danger'> <a style='color:black;text-decoration:none;' onClick='update3({$row["booking_id"]})'>Confirm </a></button>";
