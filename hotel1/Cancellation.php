...
function edit(y)
{
 ...
 if(x) {
 	...
 	window.location.replace("edit.php?id="+y);
...
function update(y)
{
 ...
 if(x) {
 	...
 	window.location.replace("Confirmation.php?id="+y);
...
<?php
            ...
            echo "<tr>";
				...
				echo "<button type='button' class='btn btn-danger'> <a style='color:black;text-decoration:none;' onClick='conDelete({$row["booking_id"]})'>Cancel </a></button>";
						...
						echo "</td>";
                echo "<td>";
				echo "<button type='button' class='btn btn-danger'> <a style='color:black;text-decoration:none;' onClick='update({$row["booking_id"]})'>Edit </a></button>";
