					 ...
					 function conDelete(y) 
{
 ...
 if(x) {
 	...
 	window.location.replace("hall_delect.php?id="+y);
...
<a class="navbar-brand" style="color:White;" href="arrangement.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Arrangement&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
	...
	<div class="row" >											
				<!--searching bar-->
					...
					<div class="col-sm-6" style="padding-right:33px;">
						<button style="float:right;" class="btn btn-dark"type="button" onClick= "window.location.href ='addhall_details.php';" ><i class=></i>Add Hall Details</button>
					</div>
									...
									<tr>
										...
										<th></th>		
											...
											if(isset($_POST["submit"])) {
												...
												$sql = "SELECT * FROM halldetails WHERE hall_name LIKE '%{$_POST["keyname"]}%' OR capacity LIKE '%{$_POST["keyname"]}%' OR price LIKE '%{$_POST["keyname"]}%' OR floor LIKE '%{$_POST["keyname"]}%'";
											...
											if ($result -> num_rows>0 ) {
											  ...
											  while($row = $result->fetch_assoc()) {
													...
													echo "<tr>";
														  ...
														  echo "<td>"; echo $row['hall_name'];  echo "</td>";
														  ...
														  echo "<td>";
														  echo "<button type='button' class='btn btn-danger'> <a style='color:white;text-decoration:none;' onClick='conDelete({$row["id"]})'>Delete </a></button>";
														  echo "</td>";
	...
	<div class="col-3">
	<i class="fa fa-envelope" aria-hidden="true"><a href="https://mail.google.com">janeshan1817@gmail.com</a></i></div>
    	<div class="col-3">
