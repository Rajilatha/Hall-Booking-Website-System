...
function conDelete(y)
{
 ...
 if(x) {
 	...
 	window.location.replace("decoration_delete.php?id="+y);
			...
			<div class="w3-card-4 w3-col s12 w3-margin">
				...
				<!--searching bar-->
					...
					<div class="col-sm-6" style="padding-right:33px;">
						<button style="float:right;" class="btn btn-dark"type="button" onClick= "window.location.href ='addnew_decoration.php';" ><i class=></i>Add New Decoration</button>
					</div>
								...
								<thead>
									...
									<?php
											...
											if(isset($_POST["submit"])) {
												...
												$sql = "SELECT * FROM decoration WHERE decoration_name LIKE '%{$_POST["keyname"]}%'  OR price LIKE '%{$_POST["keyname"]}%' OR decoration_type LIKE '%{$_POST["keyname"]}%'";
											...
											if ($result -> num_rows>0 ) {
											  ...
											  while($row = $result->fetch_assoc()) {
													...
													echo "<tr>";
														  ...
														  echo "<td>"; echo $row['decoration_name'];  echo "</td>";
														  echo "<td>"; echo $row['decoration_type'];  echo "</td>";
														  echo "<td>"; echo "<img src=Images/".$row['image_link'].">"; echo "</td>";
														
														  echo "<td>"; echo $row['price'];  echo "</td>";
														  echo "<td>";
														  echo "<button type='button' class='btn btn-danger'> <a style='color:white;text-decoration:none;' onClick='conDelete({$row["decoration_id"]})'>Delete </a></button>";
														  echo "</td>";
														}
