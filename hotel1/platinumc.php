 ...
 function conDelete(y) 
{
 ...
 if(x) {
 	...
 	window.location.replace("platinum_delete.php?id="+y);
										...
										<button class="button"><a href="PBooking.php" style="color:white; font-weight:bold; margin:5px;">Booking</a></button>
...
<table id="customers" >
  <tr><td>Hall Name</td><td>Platinum</td></tr>
  <tr><td>Seated</td><td> 500</td></tr>
  <tr><td>Floor Area</td><td>5000 square feet</td></tr>
  <tr><td>Floor</td><td>3 rd Floor</td></b></tr>
   <tr><td>Price</td><td>120,000/=</td></b></tr>
</table>
