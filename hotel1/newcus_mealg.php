...
?>								
		...
		<div class="container">
			...
			<?php
				...
				?>
			<div class="col-md-4">
				<form method="post" action="newcus_mealg.php?action=add&id=<?php echo $row["meal_id"]; ?>">
...
<?php
echo "<form action='chat3.php' method='post' id='id'>";
$cid = $_POST['cid'];
...
echo "</form>";	
?>
			<form action="newcus_mealg.php" method="post" style="align:left;">
			<div class="row">
      <div class="col-25">
...
if(isset($_POST["add_to_cart"]))
{
	...
	$sql = "INSERT INTO cartg (CustomerID,meal_id,quantity,booking_id) VALUES ('" . $CustomerID . "','" . $item_id . "','" . $item_quantity . "','" . $cid . "')";
	...
	if($_GET["action"] == "delete")
	{
		foreach($_SESSION["shopping_cart"] as $keys => $values)
		{
			if($values["item_id"] == $_GET["id"])
			{
				...
				echo '<script>window.location="newcus_mealg.php"</script>';
			}
		}
	}
}
...
$quantity=filter_input(INPUT_POST,'quantity');
		...
		if($quantity!==""||$custom!==""){
		$sql="INSERT INTO cartg ( CustomerID,quantity, meal_id,booking_id) VALUES ('$CustomerID','$quantity','$custom','$cid')";
