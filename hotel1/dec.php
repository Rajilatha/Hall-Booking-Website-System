...
?>
<div class="container">
<form action="Decoration.php" method="post" enctype="multipart/form-data"">
    <div class="row">
      <div class="col-25">
	...
	<div class="row">
      ...
      <div class="col-75">
        <input type="text" id="decid" name="decid"  required>
      </div>
    </div>
	<div class="row">
      <div class="col-25">
        <label for="custom">Custom Decoration</label>
      </div>
      <div class="col-75">
...
<?php
        ...
        if(in_array($filetype, $allowed)){
            ...
            if(file_exists("../Images/" . $file)){
               ...
               $sql="INSERT INTO `cus_decoration`(`email`, `decoration_id`, `image_link`) VALUES ('$email','$decid','$file')";

				echo $sql;
			mysqli_query($con,$sql);
			header("Location: ./cus_meal.php?meal_added_success");
...
<button class="button"><a href="cus_room.php" style="color:white; font-weight:bold; margin:5px;">Additional Room</a></button>
<button class="button"><a href="packages.php" style="color:white; font-weight:bold; margin:5px;">Employee package</a></button>
