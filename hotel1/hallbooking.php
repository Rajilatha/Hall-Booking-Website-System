...
<div class="container">
  ...
  <option value="Morning">Silver</option>
  <option value="Evening">Gold</option>
  <option value="Evening">platinum</option>
  </select>
      </div>
    </div>
...
if(isset($_POST['submit'])){
		...
		if($email!==""&&$hallname!==""&&$Date!==""&&$Time!==""&&$people!==""){
		$sql="INSERT INTO hallbooking (email, hallname, Date, Time, people) VALUES ('$email','$hallname','$Date','$Time','$people')";
	...
	<button class="button"><a href="cus_meal.php" style="color:white; font-weight:bold; margin:5px;">Book To Meal</a></button>
