...
<br></br>	
<br>		
<a href="admin_meal.php"> <button  class="button" type="submit" class="btn btn-info" style="border-radius: 10px 10px 10px 10px;">Meal</button></a>  </br> 
 <br></br>
 <br></br>
   <a href="admin_decoration.php"><button   class="button" type="submit" class="btn btn-info" style="border-radius: 10px 10px 10px 10px;">Decoration</button></a>
   <br></br>
 <br></br>
 <a href="admin_furtherarrangements.php"><button   class="button" type="submit" class="btn btn-info" style="border-radius: 10px 10px 10px 10px;">Further Arrangements</button></a>
   <br></br>
 <br></br>
...
<div class="img col-3">
<img src="15.jpg" style="height:500px;width:1000px">
</div>
</div>
