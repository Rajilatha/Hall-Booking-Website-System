							...
							<tbody>
								...
								<?php 
											if(isset($_POST["submit"])) {
												...
												$sql = "SELECT * FROM gold WHERE CustomerID LIKE '%{$_POST["keyname"]}%' OR Date LIKE '%{$_POST["keyname"]}%' OR Time LIKE '%{$_POST["keyname"]}%' OR dob LIKE '%{$_POST["keyname"]}%' OR people LIKE '"; 
